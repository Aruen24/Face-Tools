...
if __name__ == '__main__':
    args = parse_args()
    # 首先加载网络模型
    model = hutian_resnet100.iresnet100(pretrained=False, if_softmax = False, if_l2_norm = False)
    pre_dict = torch.load("/home/mapengfei/data/FR/vargfacenet/save/r100_arcface_no_kd_288127id_1.25/Epoch_36.pt")
