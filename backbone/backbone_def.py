...
from backbone.hutian_varGFaceNet_swish_new import varGFaceNet_swish_new
...
class BackboneFactory:
    ...
    def get_backbone(self):
        ...
        elif self.backbone_type =='vargfacenet':
            if_softmax = self.backbone_param['if_softmax']
            if_l2_norm = self.backbone_param['if_l2_norm']
            multiplier = self.backbone_param['multiplier']
            backbone = varGFaceNet_swish_new(if_softmax = if_softmax, if_l2_norm = if_l2_norm, multiplier = multiplier)
        else:
            pass
        return backbone
