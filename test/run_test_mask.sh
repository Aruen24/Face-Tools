...
python store_feature_mask.py --db $db_name --model $model_name --anchor_pics_path ./test_data/mask/anchor

python test_validate_1vN_mask.py --db $db_name --model $model_name --val_pics_path ./test_data/mask/not_in
python test_validate_1vN_mask.py --db $db_name --model $model_name --val_pics_path ./test_data/mask/in
